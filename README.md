...
4) you can download COCO weights (that you will need in custom.py) from here: https://github.com/matterport/Mask_RCNN/releases/download/v2.0/mask_rcnn_coco.h5
